...
![FSR base reference](./images/Ref_FSRbase.png)


DRV2605L は本体基板下の空間に配置、こちらも両面テープ固定しています。
![PAD lid reference](./images/Ref_DRV.png)
...
下記画像は横から見た図です。
![PAD lid part 1](./images/part_PADlid_1.png)
...
![PAD lid part 2](./images/part_PADlid_2.png)
...
![FSR base part](./images/part_FSRbase.png)
